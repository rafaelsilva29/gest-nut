...
import smartThings.gestNuT.service.EmailService;
...
class SignupController {
	...
	private static final String CONFIRM_VIEW_NAME = "signup/confirm";
	...
	@Autowired
	public SignupController(BCryptPasswordEncoder bCryptPasswordEncoder, UserService userService, EmailService emailService) {
	...
	public ModelAndView processRegistrationForm(ModelAndView modelAndView, @Valid User user, BindingResult bindingResult, HttpServletRequest request, RedirectAttributes ra) {
